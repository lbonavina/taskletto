...
class DashboardController extends Controller
{
    public function index(): View
    {
        ...
        $urgentTasks = Task::whereNotIn('status', ['completed', 'cancelled'])
        ...
        // Recent notes (max 4)
        $recentNotes = Note::orderByDesc('updated_at')->limit(4)->get();

        // In-progress tasks (max 4)
        ...
        // Category breakdown
        $categories = Category::withCount('tasks')->get()->filter(fn($c) => $c->tasks_count > 0)->sortByDesc('tasks_count')->take(5);
        ...
        return view('dashboard', compact(
            ...
            'days', 'urgentTasks', 'recentNotes', 'inProgressTasks',
            'categories', 'totalNotes', 'pinnedNotes'
